<div class="sidebar-wrapper">
        <div class="sidebar">
            ...
            <ul>
            <li><?php echo anchor("rm_controller/analyticsnew", "Overviews",['class'=>"active normal"]) ?></li>
            ...
            <li><?php echo anchor("rm_controller/users", "Users",['class'=>"normal"]) ?></li>
             ...
             <li><?php echo anchor("rm_controller/orders", "Orders",['class'=>"normal"]) ?></li>
               ...
               <li><?php //echo anchor("rm_controller/analytics", "Analytics",['class'=>"active normal"]) ?></li>
            </ul>
